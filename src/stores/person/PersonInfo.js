...
export const [experience, SetExperience] = createSignal([
  {
    date: "2023-01-15",
    catagory: "[INFO]",
    title: "PROMOTED TO LEAD_ARCHITECT @ NEON_CORP",
    url: "",
    endDate: "",
    duration: "",
  },
  {
    date: "2022-09-01",
    catagory: "[INFO]",
    title: "STARTED AT NEON_CORP AS SR_DEV",
    url: "",
    endDate: "",
    duration: "",
  },
  {
    date: "2020-03-10",
    catagory: "[WARN]",
    title: "SURVIVED Y2K20 ARCHITECTURE MIGRATION",
    url: "",
    endDate: "",
    duration: "",
  },
  {
    date: "2018-06-01",
    catagory: "[INFO]",
    title: "INITIATED BOOTCAMP_TRAINING_PROTOCOL",
    url: "",
    endDate: "",
    duration: "",
  },
...
export const [projects, SetProjects] = createSignal([
  {
    title: "PROJECT_ALPHA",
    desc: "A low-res, 8-bit style pixel art landscape showing a cyberpunk city skyline at night with glowing neon cyan and magenta lights reflecting off rain-slicked streets. Blocky, high-contrast.",
    thumbnal:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuA0n2x_1uGh615rA61nAe7EAYpxUU4dlcifnuCNQ0KpwK9uoHQ9EhZHMkbitRV1YZsQvD3wbVQ_S81MNCMsQo_H1lwfbGlN6HmO0TBXAzzycLPAIhWjVNtL44DIbJ9oZ6YFD1WC8vHTIabjIHBSAauwLU9vcHjiaNgrFcdSZO2ynbGyt0GXFe1PFms0lZp3EdBMMkVMPOFtZ4PjvUcNWiAEdlixOQ8ZZmYBODPFI2Ej18bky4QVJXI",
    about_line_1: "> High-frequency trading bot framework.",
    about_line_2: "> Built with Rust & WebSockets.",
    about_line_3: "> Latency < 5ms.",
    github: "#",
    deployment: "#",
    status: "[ONLINE]",
  },
  {
    title: "DATA_VIS_CORE",
    desc: "An abstract visualization of data nodes connecting like a neural network, rendered in jagged, low-fidelity 8-bit graphics with vibrant cyan and white lines on a stark black background. High contrast.",
    thumbnal:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBS-Qncd2xEjYEr4CRnYkz_yCQL4mRZAY5n3cA7U7MmOpkF5UJoLfrECXhhktsH_5Tx3UdtGDV7USq6CHCUFJf7sDKV4toiEzfx71DSxBd8YyKcnmmrFQWhuh8Zz7VUj4OyGpoO7svRJfgl_jblTEbW1Uia6aniV_KSM0uiR5bHDCP6wTSk0hxi8kwFXLcat2wLOPAuTuTQcKsFDiCYEefLm2F3-n7Qfo2fYlReRIR51z6a25MGTZE",
    about_line_1: "> Real-time network topology visualizer.",
    about_line_2: "> D3.js + WebGL rendering engine.",
    about_line_3: "> Handles 10k+ nodes smoothly.",
    github: "#",
    deployment: "#",
    status: "[ONLINE]",
  },
  {
    title: "NET_SEC_TOOL",
    desc: "A pixelated lock icon surrounded by cascading binary code raining down matrix-style. The color palette is strictly black, dark teal, and vibrant cyan. Rough, brutalist aesthetic.",
    thumbnal:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuDUZm6YViseGg7cXKYBBgNJZAKr3jvcHZqIWvYhhuMPsrnqnNkyp_ezCXxDHhzsIHkZHJke9GFBS_38o3gY5Zvp53cDNXi9AE9FqgUfhTel45uYdO5sjup511GC4IGU5vTzVUCSCCH0Lx6pQ5edn0ni63jWdRxQB-goI27QucZd6pMpwryZwR6AI0STdURKc9xlX8W-OA59wiHxxaWNA8YnZ5NuewE7b5TbcJJmu0jc7C_0Z2BgyaQ",
    about_line_1: "> Automated penetration testing suite.",
    about_line_2: "> Python CLI interface.",
    about_line_3: "> CVE database integration.",
    github: "#",
    deployment: "",
    status: "[MAINTENANCE]",
  },
  {
    title: "CRYO_ENGINE",
    desc: "A 3D wireframe render of a geometric spacecraft rotating, displayed on an old CRT monitor with heavy scanlines and chromatic aberration. Monochromatic cyan on black.",
    thumbnal:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCHVxvmefk1cBxKP45k_yqRj-UfzTMMwrFAFXopQ7ryCYMyoewVquiRou3uXLsv9pRfvKQmuG6jko9tqU4lC0H6ny-o3-yYwYXlnYhr65N7cZ1YdpN31WiDf46MJTCpv-4TmAabUuLuIVu0w2DJJLXyUwkgFmONBNxYU_O5waMKu4F4xfhKjTOe_neYm6pSgSjZOaA17x5elkqyKb4PNtAfkUo1mXz0y-CSKoPT8_USTA9pOA_6qbc",
    about_line_1: "> Custom 2D game engine.",
    about_line_2: "> ECS architecture.",
    about_line_3: "> Cross-platform compilation (WASM).",
    github: "#",
    deployment: "#",
    status: "[ONLINE]",
  },
  {
    ...
    desc: "",
    thumbnal: "",
    about_line_1: "[REDACTED]",
    about_line_2: "Classified experimental build.",
    about_line_3: "Awaiting clearance.",
    github: "",
    deployment: "",
    status: "[OFFLINE]",
  },
